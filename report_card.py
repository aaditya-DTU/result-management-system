...
class reportClass:
    def __init__(self,root):
        ...
        lbl_marks_ob=Label(self.root,text="Marks Obtained",font=("times new roman",15,"bold"),bg="white",bd=2 ,relief=GROOVE).place(x=600,y=230,width=150,height=50)
        lbl_total_marks=Label(self.root,text="Total Marks",font=("times new roman",15,"bold"),bg="white",bd=2 ,relief=GROOVE).place(x=750,y=230,width=150,height=50)
        ...
        self.total_marks=Label(self.root,font=("times new roman",15,"bold"),bg="white",bd=2 ,relief=GROOVE)
    ...
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                ...
                if row!=None:
                    self.var_id=row[0]
                    self.roll.config(text=row[1])     #row[0] is id
    ...
    def clear(self):
        self.var_id=""
        self.roll.config(text="")     #row[0] is id
