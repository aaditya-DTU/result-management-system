...
class resultClass:
    def __init__(self,root):
        ...
        txt_name=Entry(self.root,textvariable=self.var_name ,font=("times new roman",20),bg="lightyellow",state='readonly').place(x=280,y=160,width=320)
        txt_course=Entry(self.root,textvariable=self.var_course,font=("times new roman",20),bg="lightyellow",state='readonly').place(x=280,y=220,width=320)
        txt_marks_ob=Entry(self.root,textvariable=self.var_marks_ob,font=("times new roman",20),bg="lightyellow").place(x=280,y=280,width=320)
        txt_full_marks=Entry(self.root,textvariable=self.var_full_marks,font=("times new roman",20),bg="lightyellow").place(x=280,y=340,width=320)
